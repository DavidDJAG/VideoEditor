...
public sealed class MainWindowDesignViewModel
{
    ...
    public sealed class DesignModulesWorkbenchViewModel
    {
        ...
        public VidEditor.Domain.Models.StreamProcessingMode ConvertVideoMode { get; set; } = VidEditor.Domain.Models.StreamProcessingMode.Encode;
        public string ConvertVideoCodec { get; set; } = "libx264";
        public VidEditor.Domain.Models.VideoRateControlMode ConvertVideoRateControlMode { get; set; } = VidEditor.Domain.Models.VideoRateControlMode.Bitrate;
        ...
        public VidEditor.Domain.Models.FrameRateMode ConvertVideoFrameRateMode { get; set; } = VidEditor.Domain.Models.FrameRateMode.KeepSource;
        public string ConvertVideoFrameRateText { get; set; } = string.Empty;
        public VidEditor.Domain.Models.ScaleMode ConvertVideoScaleMode { get; set; } = VidEditor.Domain.Models.ScaleMode.KeepSource;
        ...
        public VidEditor.Domain.Models.StreamProcessingMode ConvertAudioMode { get; set; } = VidEditor.Domain.Models.StreamProcessingMode.Encode;
        ...
        public IEnumerable<ContainerDefinition> ConvertContainerOptions { get; } = ContainerCatalog.GetUserSelectableContainers();
        ...
        public IEnumerable<VidEditor.Domain.Models.StreamProcessingMode> ConvertStreamProcessingModes { get; } = Enum.GetValues<VidEditor.Domain.Models.StreamProcessingMode>();
        public IEnumerable<VidEditor.Domain.Models.VideoRateControlMode> ConvertVideoRateControlModes { get; } = Enum.GetValues<VidEditor.Domain.Models.VideoRateControlMode>();
        public IEnumerable<VidEditor.Domain.Models.FrameRateMode> ConvertFrameRateModes { get; } = Enum.GetValues<VidEditor.Domain.Models.FrameRateMode>();
        public IEnumerable<VidEditor.Domain.Models.ScaleMode> ConvertScaleModes { get; } = Enum.GetValues<VidEditor.Domain.Models.ScaleMode>();
